...
export default function Privacy() {
	return (
		...
		>
			...
			<p>
				BADERproductions built the Filelist app as an Open Source app. This
				SERVICE is provided by BADERproductions at no cost and is intended for
				use as is.
			</p>{' '}
			<p>
			...
			<p>
				...
				Terms and Conditions, which is accessible at Filelist unless otherwise
			...
			<p>This policy is effective as of 2020-10-04</p>{' '}
			<p>
				<strong>Contact Us</strong>
			</p>{' '}
			<p>
				If you have any questions or suggestions about our Privacy Policy, do
				not hesitate to contact us at kevin.bader96@gmail.com
			</p>{' '}
		</div>
	);
}
