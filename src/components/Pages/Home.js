      ...
      <div className="about-page">
          ...
          <div className="me-container">
            ...
            <div className="about-me">
              <p>
                ...
                <br />
                Can easily blend in and adapt to working either as a team member
                or individually and always get the job done on time.
              </p>
            </div>
          </div>
            ...
            <div className="buttons">
              ...
              <div className="answer1">
                <p>
                  ...
                  playing for a few days with any of the toys my parents bought
                  me, it always ended by opening them up to find out what are
                  the mechanisms that make them work the way they do.
                  <br />
                  <br />
                  At 10 years old I builded my first computer piece by piece.
                  <br />
                  And more recently I managed to 'hack(intosh)' my AMD Ryzen
                  computer into running macOS (Apple's OS), running both Windows
                  10 and macOS High Sierra in dual-boot.
                </p>
              </div>
              <button type="button" className="collapse">
              ...
              <div className="answer2">
                <p>
                  One that comes to mind right away is getting so absorbed in my
                  work that I lose track of time. I know I should be more aware
                  of the clock, but when I love what I'm doing I just can't
                  think of anything else.
                  <br />
                  <br />
                  Another one would be the fact that I'm brutally honest with
                  people around me. Some people are finding this hard to swallow
                  but this is my way of making sure that I don't waste anybody's
                  time. Going straight to the problem's core and fixing it right
                  away.
                </p>
              </div>
              <button type="button" className="collapse">
                Tell me about the toughest decision you had to make in the past
                years.
              </button>
              <div className="answer3">
                <p>
                  ...
                  make for a long time. I sold my computer and my guitar, booked
                  my plane ticket and I flew to England.
                  <br />
                  <br />
              ...
              <div className="answer4">
                <p>
                  ...
                  artistic escape and I really enjoy cooking because is a primal
                  thing we all share. I've had this job for 1.5 years now, it's
                  not a full-time job and the only reason I've had theis job is
                  to pay the bills while I was learning Web Development.
                  <br />
        ...
        */}
        <div className="about-footer">
          <a href="https://github.com/baderproductions" title="GitHub Account">
            <i className="fab fa-github"></i>
          </a>
          <a
